...
import com.rafaquarta.whatsapp.fragment.ContatosFragment;
import com.rafaquarta.whatsapp.fragment.ConversasFragment;
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                switch (viewPager.getCurrentItem()){
                    ...
                    case 1:
                        ...
                        if(newText != null && !newText.isEmpty()){
                            contatosFragment.pesquisarCotatos(newText.toLowerCase());
                        }else {
